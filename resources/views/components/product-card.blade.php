<div class="md:w-2/12 sm:w-24 mx-auto sm:h-72 bg-gray-200 rounded-lg my-4 p-2">
    <img 
    ...
    <div class="text-lg text-blue-600">
      Lorem Ipsum tada dasa lala
    </div>
    <div class="text-md">
      Rs 2100.00
    </div>
    <x-jet-button class="bg-amber-500 text-lg h-8 m-2 sm:m-0">
      Shop
  </x-jet-button>
  </div>  
