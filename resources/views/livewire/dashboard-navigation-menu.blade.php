        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="text-xl text-indigo-600">
                        Crockey-Online
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">                
                    ...
                    <x-jet-dropdown width="48">
                        ...
                        <x-slot name="content">
                            <x-jet-dropdown-link href="{{ route('dashboard.products.index') }}">
                                {{ __('All Products') }}
                            </x-jet-dropdown-link>
                    ...
                    <x-jet-nav-link href="{{ route('categories.create') }}" :active="request()->routeIs('category.index')">
                        {{ __('Categories') }}
                    </x-jet-nav-link>
