                        ...
                        <form method="POST" action="{{ route('products.update',$product->id) }}" class="block">
                            ...
                            <div class="flex flex-col sm:flex-row justify-center justify-items-center">
                                ...
                                <div class="ml-5">
                                    ...
                                    <textarea name="description" class="mt-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" id="discription" cols="30" rows="10">{{old('description') ? old('discription') : $product->description}}</textarea> 
                                </div>
                            </div>
