                                ...
                                <div class="flex flex-col text-lg sm:flex-row justify-center justify-items-center">
                                    ...
                                    <div class="flex flex-col space-y-6">
                                        <div class="">
                                            ...
                                            <x-jet-input id="name" class="block mt-1 w-full p-3" type="text" name="name" :value="old('name')" value="{{ $category->name }}"   required autofocus autocomplete="name" />
                                        </div>
                                        <div class="ml-5">
                                            <x-jet-label for="description" value="{{ __('Description') }}" />
                                            <textarea id="description" name="description" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" id="discription" cols="30" rows="10">{{ old('discription') ?? $category->description }}</textarea> 
                                        </div>
