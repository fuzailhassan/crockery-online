    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                ...
                {{-- Featured producrts--}}
                <div class="flex flex-col text-center justify-center sm:flex-row">
                    ...
                    <div class="mx-auto text-center text-2xl font-semibold my-4 sm:mt-8 ">
                        Featured Product
                    </div>
        ...
        <div class="flex flex-col sm:flex-row bg-gray-800 text-white p-2 text-center sm:text-left">
